...
You take some notes ([(your puzzle input)](data/input.txt)) on the items each monkey currently has, how worried you are about those items, and how the monkey makes decisions based on your worry level. For example:
